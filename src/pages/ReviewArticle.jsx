...
// The review page's action button. Points at the site's /go/<keyword> page
// by default, or the review's own campaign URL (ctaUrl) when one is set.
...
export default function ReviewArticle() {
  ...
  const subScores = RATING_DIMENSIONS.map((d) => [d.name, review.scorecard[d.key]])
        ...
        <div className="container">
          ...
          <div className="article-head__meta">
            ...
            <div className="article-head__score">
              ...
              <span className="article-head__score-num">{review.rating.toFixed(1)}</span>
          ...
          <aside className="article-body__aside">
            <div className="aside-card">
              ...
              <div className="aside-rating">
                <span className="aside-rating__num">{review.rating.toFixed(1)} / 5</span>
